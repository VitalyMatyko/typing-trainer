...
const CreateAccountForm: React.FC<UserSingUpPageProps> = ({
	...
	return (
		<div className="user_sing_up_page">
			...
			<form onSubmit={getUserSignUp} method="POST" className="registration_form_container">
				<div className="top_stripe_background"></div>
				<div className="registration_form_text">
					<div className="userSvg_registration_form">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							...
							<path fill="#f4f4f4" fillRule="nonzero"
								d="M246.999 0c139.846 0 247 118.492 247 255.749 0 137.286-107.146 255.751-247 
							255.751C107.136 511.5 0 393.041 0 255.749 0 119.253 106.347 0 246.999 0z" />
							<path fill="#194794" fillRule="nonzero" d="M443.262 410.755c-44.365 60.337-114.245 
				...
				<div className="registration_form">
					<div className="user_name">
						<input
							className={`user_name_input ${validationInputRegistrationData.userNameOk ? 'check_border' : validationInputRegistrationData.userNameError ? 'error_border' : ''}`}
							onChange={(event) => getUserInputRegistrationData(event)}
							onBlur={handleOnBlurRegistrationForm}
							onFocus={handleOnFocusRegistrationForm}
							type="text"
							name="userName"
							id="userName"
							value={userInputRegistrationData.userName}
							placeholder="Enter your name..." />
						<div className="validataion_svg_ok">
							{validationInputRegistrationData.userNameOk
								? (<svg
									className="check"
									viewBox="0 0 24 24"
									xmlns="http://www.w3.org/2000/svg">
								...
								: validationInputRegistrationData.userNameError
									? (<svg
										className="error"
										viewBox="0 0 24 24"
										xmlns="http://www.w3.org/2000/svg">
					...
					<div className="user_email">
						<input
							className={`user_email_input ${validationInputRegistrationData.userEmailOk ? 'check_border' : validationInputRegistrationData.userEmailError ? 'error_border' : ''}`}
							onChange={(event) => getUserInputRegistrationData(event)}
							onBlur={handleOnBlurRegistrationForm}
							onFocus={handleOnFocusRegistrationForm}
							type="text"
							name="userEmail"
							id="userEmail"
							value={userInputRegistrationData.userEmail}
						...
						<div className="validataion_svg_ok">
							{validationInputRegistrationData.userEmailOk
								...
								: validationInputRegistrationData.userEmailError
									? (<svg
										className="error"
										viewBox="0 0 24 24"
										xmlns="http://www.w3.org/2000/svg">
					...
					<div className="user_password">
						<input
							className={`user_password_input ${validationInputRegistrationData.userPasswordOk ? 'check_border' : validationInputRegistrationData.userPasswordError ? 'error_border' : ''}`}
							onChange={(event) => getUserInputRegistrationData(event)}
							onBlur={handleOnBlurRegistrationForm}
							onFocus={handleOnFocusRegistrationForm}
							type="text"
							name="userPassword"
							id="userPassword"
							value={userInputRegistrationData.userPassword}
							placeholder="Enter your password..." />
						<div className="validataion_svg_ok">
							{validationInputRegistrationData.userPasswordOk
								? (<svg
									className="check"
									viewBox="0 0 24 24"
									xmlns="http://www.w3.org/2000/svg">
								...
								: validationInputRegistrationData.userPasswordError
									? (<svg
										className="error"
										viewBox="0 0 24 24"
										xmlns="http://www.w3.org/2000/svg">
